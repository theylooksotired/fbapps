...
class Navigation_Ui extends Ui {
	...
	public function menu() {
		return '<div class="menu">
					<div class="menuItem"><a href="'.url('servicios').'">Servicios</a></div>
					<div class="menuItem"><a href="'.url('equipo').'">Equipo</a></div>
					<div class="menuItem"><a href="'.url('portafolio').'">Portafolio</a></div>
					<div class="menuItem"><a href="'.url('blog').'">Blog</a></div>
					<div class="menuItem"><a href="'.url('contacto').'">Contacto</a></div>
				</div>';
	}
